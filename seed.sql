...
-- ==== STUDENT PROGRESS ====
-- Student 1 đã xem một số bài
INSERT INTO student_lesson_progress (student_id, lesson_id, watched_s, is_completed, last_seen_at) VALUES
(1, 1, 695, true, NOW() - INTERVAL '2 days'),
(1, 2, 400, false, NOW() - INTERVAL '1 day'),
(1, 4, 1450, true, NOW() - INTERVAL '3 days');

-- Course progress
INSERT INTO student_course_progress (student_id, course_id, percent, updated_at) VALUES
(1, 1, 28.57, NOW()),
(1, 2, 0, NOW()),
(2, 3, 0, NOW());
...
(2, 'VNPAY', 'VNPAY_TXN_123456', 490000, 'VND', 'PAID', NOW() - INTERVAL '3 days'),
(3, 'MOMO', 'MOMO_TXN_789012', 590000, 'VND', 'PAID', NOW() - INTERVAL '5 days');
