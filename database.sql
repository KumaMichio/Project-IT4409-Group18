...
-- Tạo database online_course và kết nối
-- Note: Database name matches docker-compose.yml (POSTGRES_DB: online_course)
...
-- Indexes for payments (quan trọng cho admin revenue queries)
...
-- Indexes for audit_logs (quan trọng cho admin queries)
